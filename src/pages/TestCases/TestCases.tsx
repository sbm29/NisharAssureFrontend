...
const TestCases = () => {
  return (
    <MainLayout>
      <div className="flex justify-center items-center h-full px-6 pt-4 ">
        <Card className="max-w-lg w-full text-center shadow-md border border-dashed">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              We’re crafting something awesome here! The{" "}
              <span className="font-semibold">Test Case</span> feature is under
              active development and will be available in an upcoming release.
            </p>

            <div className="flex items-center justify-center space-x-2 text-sm text-muted-foreground">
              <Wrench className="h-4 w-4" />
              <span>
                Expected in: <strong>Next Beta Update</strong>
              </span>
            </div>
