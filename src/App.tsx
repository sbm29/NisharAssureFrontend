        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              {/* Protected routes (use ProtectedRoute per-route with allowedRoles) */}
              <Route
                path="/"
                element={
                  <ProtectedRoute
                    allowedRoles={[ROLES.ADMIN, ROLES.MANAGER, ROLES.ENGINEER]}
                  >
                    <Dashboard />
                  </ProtectedRoute>
                }
              ...
              {/* Uncomment / protect if you bring ProjectStructure back */}
              {/*
              <Route
                path="/projects/:id/structure"
                element={
                  <ProtectedRoute allowedRoles={[ROLES.ADMIN, ROLES.MANAGER, ROLES.ENGINEER]}>
                    <ProjectStructure />
                  </ProtectedRoute>
                }
              />
              */}
              ...
              {/* 404 route - keep outside ProtectedRoute so unauthenticated users can see it */}
              <Route path="*" element={<NotFound />} />
            </Routes>
          </BrowserRouter>
        </TooltipProvider>
